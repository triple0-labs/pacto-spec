...
func commandCatalog() []CommandHelp {
	return []CommandHelp{
		...
		},
		{
			...
			Description: "Generates split plan artifacts (`spec.md`, `design.md`, `tasks.md`) plus README. Plan status is derived from state folders and plan documents. If --root is omitted, auto-discovers from current directory and parents.",
			Examples: []string{
				...
				"pacto new to-implement sandbox --root /tmp/pacto-demo --allow-minimal-root",
			},
		},
		{
			Name:        "explore",
